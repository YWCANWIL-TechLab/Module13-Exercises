...
class BankAccount {
    ...
    static #allAccountsBalance = 0;

    constructor(balance) {
        this.#balance = balance;
        this.#accountId = this.#lastAccountId++;
        BankAccount.#lastAccountId = this.#accountId;
        BankAccount.#allAccountsBalance += balance;
    }
    ...
    deposit(dollars) {
        ...
        BankAccount.#allAccountsBalance += dollars;
        return this.#balance;
    }
    ...
    static balanceOfAllAccounts() {
        return BankAccount.#allAccountsBalance;
    }
}

const acc1 = new BankAccount(50, 0);
const acc2 = new BankAccount(500, 1);
const acc3 = new BankAccount(5000, 2);

console.log(BankAccount.balanceOfAllAccounts()); // Output: 5550
